        ...
        <div className="row">
          <div className="col-md-4 col-md-6 center">
            ...
            <div className="col" style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div className="col">
                <h2 className="white bold">DEPOSITOS EN OXXO 2:</h2>
                <p className="bold" style={{ fontSize: '20px' }}>CUENTA: 2242-1707-6018-2351</p>
                
              </div>
              <div className="col">
                <h2 className="white bold">DEPOSITOS EN OXXO 2:</h2>
                <p className="bold" style={{ fontSize: '20px' }}>CUENTA: 2242-1707-6024-2905</p>
