...
//OPORTUNIDADES ADICIONALES:
 ...
 estaremos recibiendo los pagos *hasta las 11:00 pm* del día de hoy , si desea que le esperemos un poco más por favor nos confirma. Gracias🌸
...
A NOMBRE DE: ${fullName}.
 ...
 const phoneNumber = userData.user.phoneNumber.replace(/\s/g, "");
  ...
  const message = `Buenos días 🌞 hoy es la rifa de los $15,000 pesos 💸 ¿aun le interesan sus boletos? ✨
`
 const whatsappUrl = `https://api.whatsapp.com/send?phone=${phoneNumber}&text=${encodeURIComponent(message)}`;
  window.open(whatsappUrl, "_blank");
