...
const [confirmationSentEmails, setConfirmationSentEmails] = useState([]);
  ...
  𝙋𝘼𝙍𝘼 𝙀𝙇 𝙎𝙊𝙍𝙏𝙀𝙊 𝘿𝙀: $5000 PESOS 💸💰
  𝘿𝙀𝙇 𝘿𝙄𝘼: 30 DE MARZO DE 2025.
...
//OPORTUNIDADES ADICIONALES:
 ...
 const phoneNumber = userData.user.phoneNumber.replace(/\s/g, "");
  ...
  const message = `HOLA BUENOS DIA SOLO PARA RECORDAR QUE EL DIA DE HOY SE LLEVARA ACABO LA RIFA DE LOS $5000 PESOS💸
  𝗘𝗦𝗧𝗔𝗥𝗘𝗠𝗢𝗦 𝗥𝗘𝗖𝗜𝗕𝗜𝗘𝗡𝗗𝗢 𝗟𝗢𝗦 𝗣𝗔𝗚𝗢𝗦 𝗛𝗔𝗦𝗧𝗔 𝗟𝗔𝗦 5:00𝗣𝗠 𝗗𝗘𝗟 𝗗𝗜𝗔 𝗗𝗘 𝗛𝗢𝗬. Si necesita que esperemos un poco mas nos confirma por favor.☺️
