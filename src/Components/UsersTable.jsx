...
Si gusta que esperemos un poco mas nos confirma por favor. Gracias ☺️✨️
 ...
 const phoneNumber = userData.user.phoneNumber.replace(/\s/g, "");
  ...
  const message = `Hola buenas noches, el dia de hoy desde las 10 am estaremos pasando a cobrar lo de la rifa de los $15,000 pesos. Esta en su casa? para llegar de pasadita.☺️🌸
