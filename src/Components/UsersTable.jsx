...
//OPORTUNIDADES ADICIONALES:
 ...
 estaremos recibiendo los pagos *hasta las 11:00 pm* del día de hoy, si desea que le esperemos poco mas porfavor favor nos confirma. Gracias🌸
 ...
 const phoneNumber = userData.user.phoneNumber.replace(/\s/g, "");
  ...
  const message = `Hola buen dia, *hoy entre las 1:00 y 2pm* estaremos pasando a cobrar lo de la rifa del dia de hoy. estara en su casa?✨☺️
`
 const whatsappUrl = `https://api.whatsapp.com/send?phone=${phoneNumber}&text=${encodeURIComponent(message)}`;
  window.open(whatsappUrl, "_blank");
