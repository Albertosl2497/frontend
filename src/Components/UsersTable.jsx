...
//OPORTUNIDADES ADICIONALES:
 ...
 estaremos recibiendo los pagos *hasta las 04:30 pm* del día de hoy , si desea que le esperemos un poco más por favor nos confirma. Gracias🌸
...
A NOMBRE DE: ${fullName}.
 ...
 const phoneNumber = userData.user.phoneNumber.replace(/\s/g, "");
  ...
  const message = `Buenas tardes 🌞 solo para ver si aun le interesan sus boletos para la rifa de *los $15mil* pesos del dia de hoy✨
`
 const whatsappUrl = `https://api.whatsapp.com/send?phone=${phoneNumber}&text=${encodeURIComponent(message)}`;
  window.open(whatsappUrl, "_blank");
