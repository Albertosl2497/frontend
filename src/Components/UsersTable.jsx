...
//OPORTUNIDADES ADICIONALES:
 ...
 estaremos recibiendo los pagos *hasta las 4:00 pm* del día de hoy , si desea que le esperemos un poco más por favor nos confirma porfavor. Gracias🌸
...
A NOMBRE DE: ${fullName}.
 ...
 const phoneNumber = userData.user.phoneNumber.replace(/\s/g, "");
  ...
  const message = `Buenos días 🌞 hoy es la rifa de los $15,000 pesos 💸 Solo par ver si aun le interesan sus boletos ✨
`
 const whatsappUrl = `https://api.whatsapp.com/send?phone=${phoneNumber}&text=${encodeURIComponent(message)}`;
  window.open(whatsappUrl, "_blank");
