...
function MainPageContent() {
  return (
    <div className="col" style={{ display: 'flex', flexDirection: 'column' }}>
      <p className="bold" style={{ fontSize: '24px' }}>GRAN EDICIÓN # 22</p>
      <p className="bold" style={{ fontSize: '24px' }}>ESTE 03 DE DICIEMBRE</p>
...
Liquida tus boletos en tiempo y forma para que puedas participar en nuestro sorteo de los $5000  en Efectivo.
      </p>
